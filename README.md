...
[![Pytest](https://img.shields.io/badge/Tests-30%20Passed-4CAF50?style=for-the-badge)](https://pytest.org)
...
7. **Production DevSecOps CI/CD & Automated Security:**
   - Automated GitHub push workflow with `.gitignore` secret isolation, GitHub Secret Scanning prevention, and continuous automated testing (30-Test Pytest Suite).
...
9. **AST-Level SQL Security Guardrails & Prompt Injection Defense:**
